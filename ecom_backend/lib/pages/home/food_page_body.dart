...
import 'package:ecom_backend/widgets/icon_and_text_widget.dart';
...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        //slider section
        GetBuilder<PoppularProductController>(builder: (popularProducts){
          return Container(
...
// )
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      BigText(text: "Nuguri food meal idsa dsads in China "),
                      SizedBox(height: Dimensions.height10,),
                      SmallText(text: "With China characterristic"),
                      SizedBox(height: Dimensions.height10,),
                      Row(
  ...
  // xu ly duong cong cua thanh san pham nhung android không hỗ trợ chức năng này nên bỏ
